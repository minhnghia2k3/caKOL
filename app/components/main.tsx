      ...
      <div className="image-main flex items-center justify-center overflow-hidden">
        <div className="left px-10 text-center ">
          ...
          <p className="my-10 sm:text-xl">
            Với kinh nghiệm triển khai 1000+ dự án, book KOL chắc chắn sẽ mang
      ...
      <div className="element-number bg-black text-white sm:p-10 sm:pt-20">
        ...
        >
          <div className="text-center">
            ...
            <p className="text-[12px] text-[#e19a48] sm:mt-10">KOLS</p>
          </div>
          <div className="text-center">
            <h3 className="text-2xl md:text-[80px]">175000+</h3>
            <p className="text-[12px] text-[#e19a48] sm:mt-10">MEMBERSHIP</p>
          </div>
          <div className="text-center">
            <h3 className="text-2xl md:text-[80px]">1532</h3>
            <p className="text-[12px] text-[#e19a48] sm:mt-10">PROJECT</p>
          </div>
          <div className="text-center">
            <h3 className="text-2xl md:text-[80px]">1168</h3>
            <p className="text-[12px] text-[#e19a48] sm:mt-10">HAPPY CLIENTS</p>
          </div>
        </div>
      </div>
      <div className="mt-20 flex items-center justify-center">
        <div className="w-[80%] text-center">
          ...
          <p className="my-10 text-xl">
            Trong 5 năm làm KOL Marketing và triển khai 1000+ dự án, chúng tôi
            đã chiêm nghiệm, tổng hợp, đúc kết được các phương pháp KOL
            Marketing tốt nhất, có thể áp dụng linh hoạt vào từng yêu cầu của
            chiến dịch
          </p>
        </div>
      </div>
      <div className="mt-20 flex items-center justify-center">
        <div className="w-[80%] text-center">
          ...
          <p className="my-10 text-xl">
            ...
            <label className="font-bold text-[#e0752b]">KOL</label> được rất
            nhiều khách hàng sự tin tưởng và giao trọng trách triển khai thành
            công nhiều chiến dịch lớn bởi sự uy tín, tận tâm với đội ngũ tuyệt
            vời !!!
          </p>
        </div>
      </div>
          ...
          <div className="items-center justify-between gap-20 md:flex">
            <div className="md:w-[50%]">
              ...
              <p className="my-10 text-xl">
                ...
                <label className="font-bold text-[#e0752b]">KOL</label> trong kế
                hoạch Marketing của mình, nhằm tận dụng sức ảnh hưởng của họ tới
                công chúng, qua đó hiện thực các mục tiêu đã đề ra. Để bạn có
                cái nhìn tổng quan hơn về{" "}
                <label className="font-bold text-[#e0752b]">
                  KOL Marketing{" "}
                </label>
                , hãy cùng
                <label className="font-bold text-black"> ca</label>
                <label className="font-bold text-[#e0752b]">KOL</label> tìm hiểu
                thêm về hình thức quảng cáo đầy tiềm năng này.
              </p>
            </div>
